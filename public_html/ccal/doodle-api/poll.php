 ...
 ****************************************************************/
    ...
    function acquire_poll($url)
    {
        ...
        return $xml_and_tokens;
    }
    
    /*
     * void
     * display_poll($gcal_info, $poll)
     * 
     * Generates html to display the Doodle poll
     * on display_poll.html.
     */
     
    function display_poll(/*$gcal_info,*/$poll)
    {
        // open the table
        echo("<table>");
        ...
        foreach($poll['keys']['OPTION'] as $key => $value)
        {
            ...
            $time_range[$time] = $start[$time]." -  _<br>".$end[$time];
        }
        ...
        {
            echo("<td>");
            echo("<input type=\"checkbox\" name=\"option$i\" value=\"X\">");
            echo("</td>");
        }
        ...
        // return tokens to be used for submit
        return $poll['tokens'];      
    }
     ...
     * submit_poll($input)
     * 
     * Submits a poll to the doodle api using the user
     * input from display_poll.php. Returns true if the
     * submission went through.
     */
     
    function submit_poll($input, $tokens)
    {
